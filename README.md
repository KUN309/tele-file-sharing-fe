...
| Bùi Cung                    | Làm requirement (non-functional), use case (upload), xử lý command về upload (dự tính)    |
| Trí Thành                   | Làm requirement (non-functional), use case (revoke), xử lý command về revoke (dự tính)    |
